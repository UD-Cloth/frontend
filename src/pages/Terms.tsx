...
const Terms = () => (
  <div className="min-h-screen flex flex-col bg-background">
    <SEO title="Terms of service" description="Urban Drape terms of service." />
    <Header />
    <main className="flex-1 container px-4 md:px-8 py-10 md:py-16 max-w-3xl">
      ...
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        ...
        <p>All content on this website, including images, logos, and text, is the property of URBAN DRAPE and may not be reproduced without permission.</p>
        <h3 className="font-semibold text-foreground text-base">Limitation of Liability</h3>
        <p>URBAN DRAPE shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services.</p>
        {/* Bug #98: link the phrase "Privacy Policy" to /privacy */}
        <p>
