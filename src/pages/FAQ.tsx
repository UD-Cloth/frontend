...
const faqs = [
  ...
  { q: "How do returns work?", a: "You can initiate a return within 7 days of delivery. Items must be unused with original tags." },
...
const FAQ = () => (
  <div className="min-h-screen flex flex-col bg-background">
    <SEO title="FAQ" description="Frequently asked questions about Urban Drape orders, shipping, and returns." />
    <Header />
